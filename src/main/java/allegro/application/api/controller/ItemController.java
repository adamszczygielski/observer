...
public class ItemController {
    ...
    public String fetchItemsPreview(Model model, @PathVariable Long searchId) {
        model.addAttribute("items", applicationService.fetchItemsPreview(searchId));
        return "items-preview";
    }

    @RequestMapping("/item/list/{searchId}")
    public String fetchItems(Model model, @PathVariable Long searchId) {
        model.addAttribute("items", applicationService.fetchItems(searchId));
        return "items";
    }

    @RequestMapping("/item/list")
    public String fetchActiveItems(Model model) {
        model.addAttribute("items", applicationService.fetchActiveItems());
        return "items";
    }
