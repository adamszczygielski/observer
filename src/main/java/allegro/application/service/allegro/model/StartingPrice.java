 ...
 */
@ApiModel(description = "The starting price for offers in auction format.")
...
public class StartingPrice {
  ...
  public StartingPrice amount(String amount) {
  ...
  **/
  ...
  public StartingPrice currency(String currency) {
