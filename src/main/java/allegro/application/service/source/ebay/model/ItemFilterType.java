...
package allegro.application.service.source.ebay.model;
 ...
 *     &lt;enumeration value="OutletSellerOnly"/>
 *     &lt;enumeration value="AuthorizedSellerOnly"/>
 *     &lt;enumeration value="StartTimeFrom"/>
 *     &lt;enumeration value="StartTimeTo"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 * 
...
public enum ItemFilterType {
     ...
     * 								https://www.iso.org/obp/ui/#search/code/</a>.
     * 								<br><br>
     * 							
     * 
     */
     ...
     * 								country. The item filter <b>LocatedIn</b> cannot be used with either the  
     * 								<b>AvailableTo</b> nor the <b>MaxDistance</b> item filter.
     * 								<br><br>
     * 								<b>Allowed values (<a
     * 								class="defn_type"
     * 								href="../types/simpleTypes.html#string">string</a>):</b>
     ...
     * 								<br><br>
     * 								<b>Note: </b> The <b>MaxDistance</b> item filter cannot be used with 
     * 								either the <b>LocatedIn</b> nor the <b>AvailableTo</b> item filter.
     * 								<br><br>
     * 								<b>Allowed values (<a class="defn_type"
     * 								href="http://developer.ebay.com/DevZone/finding/CallRef/types/simpleTypes.html#int">int</a>):</b>
     * 								<br>
     ...
     * 
     */
    @XmlEnumValue("AuthorizedSellerOnly")
