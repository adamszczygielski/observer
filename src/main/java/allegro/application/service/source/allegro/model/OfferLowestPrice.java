 ...
 */
@ApiModel(description = "The lowest shipping cost available. Lack of this entity means that the offer has no shipping options (i.e. it is an advertisement or an offer with electronic delivery only).")
...
public class OfferLowestPrice {
  ...
  public OfferLowestPrice amount(String amount) {
