 ...
 */
@ApiModel(description = "A list of the different options which can be used with this category.")
...
public class CategoryOptionsDto {
  ...
  **/
  ...
  @ApiModelProperty(value = "Indicates whether offers of type ADVERTISEMENT can be listed in this category.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether advertisements listed in this category must have a price given. If the value is `true` then you don't have to provide a price when listing an advertisement in this category.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether you can combine offers from this category into variant sets based on the color and pattern.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Information whether the category supports assigning offers to a product.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the category supports creating products.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether at least one EAN is required when creating products.")
